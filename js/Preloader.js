...
(function(BasicGame) {
	...
	BasicGame.Preloader.prototype = {
		...
		preload: function () {
		    ...
		    this.load.spritesheet('character', 'assets/images/sailor_red.png', 32, 49,45);
			...
			//硬币
    		this.load.atlasJSONHash("coins", "assets/images/coins.png", "assets/imagesjson/coins.json");

   			 this.load.atlasJSONHash("player1", "assets/images/char.png", "assets/imagesjson/char.json");
